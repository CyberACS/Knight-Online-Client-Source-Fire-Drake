...
#include "../shared/database/EventScheduletournament.h"
...
#include "../shared/database/DeathMatchItems.h"
#include "../shared/database/DeathMatchItems1.h"
#include "../shared/database/DeathMatchItems2.h"
#include "../shared/database/DeathMatchItems3.h"

// Bowl Event MeLanor
#include "MonsterBowl.h"


bool CGameServerDlg::LoadDeathMatchTable3()
{
	LOAD_TABLE(CDeathMatchItems3, g_DBAgent.m_GameDB, &m_DeathMatchItemsArray3, true, false);
}


bool CGameServerDlg::LoadDeathMatchTable2()
{
	LOAD_TABLE(CDeathMatchItems2, g_DBAgent.m_GameDB, &m_DeathMatchItemsArray2, true, false);
}

bool CGameServerDlg::LoadDeathMatchTable1()
{
	LOAD_TABLE(CDeathMatchItems1, g_DBAgent.m_GameDB, &m_DeathMatchItemsArray1, true, false);
}

bool CGameServerDlg::LoadDeathMatchTable()
{
	LOAD_TABLE(CDeathMatchItems, g_DBAgent.m_GameDB, &m_DeathMatchItemsArray, true, false);
}
...
bool CGameServerDlg::LoadTournamentScheduleStatusTable()
{
	LOAD_TABLE(CEventTournamentScheduleStatus, g_DBAgent.m_GameDB, &m_EventTournamentScheduleArray, true, false);
}
...
//Bowl Event MeLanor
#pragma region CGameServerDlg::LoadMonsterBowlTable()

bool CGameServerDlg::LoadMonsterBowlTable() {
	LOAD_TABLE(CMonsterBowlTable, g_DBAgent.m_GameDB, &m_MonsterBowlArray, true, false);
}
...
bool CGameServerDlg::LoadCyberACSSettings() { return g_DBAgent.LoadCyberACSSettings(); }
bool CGameServerDlg::LoadCyberACSPusLoad() { return g_DBAgent.LoadCyberACSPusLoad(); }
bool CGameServerDlg::MannerStoreLoad() { return g_DBAgent.MannerStoreLoad(); }

bool CGameServerDlg::LoadCyberACSCollectionRaceSettings() { return g_DBAgent.LoadCyberACSCollectionRaceSettings(); }
bool CGameServerDlg::LoadCyberACSCollectionRaceHuntList() { return g_DBAgent.LoadCyberACSCollectionRaceHuntList(); }
bool CGameServerDlg::LoadLotterySettings() { return g_DBAgent.LoadLotterySettings(); }
bool CGameServerDlg::GAME_SERVER_SETTINGS() { return g_DBAgent.GAME_SERVER_SETTINGS(); }

//daily quest
bool CGameServerDlg::LoadDailySettings() { return g_DBAgent.LoadDailySettings(); }
bool CGameServerDlg::LoadDailyHuntList() { return g_DBAgent.LoadDailyHuntList(); }