...
public:
	...
	INLINE bool isNationPVPZone() { return canAttackOtherNation() && !canAttackSameNation() || canAttackOtherNation() && canAttackSameNation(); }
	...
	void UpdateDeathMatch(bool Open = true, ZoneAbilityType type = ZoneAbilityPVP);
	void UpdateMap(bool Open = true, ZoneAbilityType type = ZoneAbilityPVP);
	void UpdateVsEventMap(bool Open = true, ZoneAbilityType type = ZoneAbilityPVP);
