...
typedef CSTLMap <_ITEM_DATA>				DeathMatchItemsArray;
typedef CSTLMap <_ITEM_DATA>				DeathMatchItemsArray1;
typedef CSTLMap <_ITEM_DATA>				DeathMatchItemsArray2;
typedef CSTLMap <_ITEM_DATA>				DeathMatchItemsArray3;
...
typedef CSTLMap <_DEATHMATCH_RANKING>				UserDeathMatchRankingArray;
...
typedef CSTLMap <_DEATHMATCH_ROOM_INFO>				TempleEventDeathMatchRoomList;
...
typedef CSTLMap <_CYBERACS_SERVER_SETTINGS>			ServerSettingsArray;
...
typedef CSTLMap <_TOURNAMENT_SCHEDULE>				EventTournamentScheduleArray;
...
typedef CSTLMap <_USER_RANK_ALL>					UserRankALL;
typedef CSTLMap <_LOAD_CYBERACS_TICKETS>						LoadTickets;

typedef CSTLMap <_USER_RANK_EL>						UserRankEL;
typedef CSTLMap <_USER_RANK_KA>						UserRankKA;
typedef CSTLMap <_KINGS_LIST>						KingList;

typedef CSTLMap <_TOURNAMENT_CLANS>					KnightTournamentClanList;
...
typedef CSTLMap <_MONSTER_BOWL_TABLE>				MonsterBowlArray; // Bowl Event Melanor
...
typedef CSTLMap <_WANTED_MAIN_CONTROL>				WantedEventMainControlArray;
typedef CSTLMap <_WANTED_EVENT_SELECTED_USER>		WantedEventSelectedUserArray;

//CYBERACS Settings
typedef CSTLMap <_CYBERACS_SETTINGS>							CyberACSSettingsArray;
typedef CSTLMap <_CYBERACS_PUS_ITEM>							CyberACSPusItemArray;
typedef CSTLMap <_CYBERACS_COLLECTIONRACE_SETTINGS>			    CyberACSCollectionRaceSettingsArray;
typedef CSTLMap <_CYBERACS_COLLECTIONRACE_HUNT_LIST>			CyberACSCollectionRaceHuntListArray;
typedef CSTLMap <_CYBERACS_LOTTERY_SETTINGS>					LotteryArray;
typedef CSTLMap <_SETTINGS_INFO>								MaintainceSettingsArray;
typedef CSTLMap <_MONSTER_SEARCH_ITEM>							SearchItemArray;
typedef CSTLMap <_CYBERACS_MANNER_STORE_ITEM>							MannerStoreArray;


//DAILY QUEST m_MaintainceSettings
typedef CSTLMap <_CYBERACS_DAILY_SETTINGS>			DailySettingsArray;
typedef CSTLMap <_CYBERACS_DAILY_HUNT_LIST>			DailyHuntListArray;
typedef CSTLMap <_CYBERACS_DAILY_USER_QUEST_LIST>	        DailyUserListArray;
