...
#define LUA_CLASS CUser
	...
	(
		...
		MAKE_LUA_METHOD(TournumentCancelRegister)
		MAKE_LUA_METHOD(TournumentRegister)
...
_LUA_WRAPPER_USER_FUNCTION(JobChangeCagir, JobChangeCagir);
...
_LUA_WRAPPER_USER_FUNCTION(CheckTournumentCancelRegister, TournumentCancelRegister);
_LUA_WRAPPER_USER_FUNCTION(CheckTournumentRegister, TournumentRegister);
