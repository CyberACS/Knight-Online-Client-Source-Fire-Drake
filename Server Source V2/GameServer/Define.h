...
#define DEATHMATCH_EVENT_COUNT          3
...
#define RELOAD_KNIGHTS_AND_USER_RATING 720 // Minute
...
#define OFFLINE_MERCHANT_ITEM	  700048768
...
#define TO_USERB(v)	static_cast<CBot *>(v)
