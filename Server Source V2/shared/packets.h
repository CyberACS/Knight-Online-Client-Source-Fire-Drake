...
#define WIZ_MASTER_SECURITY		0xF9 //anticheat
#define WIZ_NATION_CHAT			0x19
#define WIZ_CYBERANTICHEAT_GUARD	0xA1	// CyberACS
...
#define PL_TIMER			0xA8
#define PL_JOBCHANGEDM		0xA7
#define PL_JOBCHANGE		0xA6
#define PL_COM				0xDE
#define PL_AUTHINFO			0xB8
#define PL_PROCINFO			0xB9
#define PL_OPEN				0xBA
#define PL_LOG				0xBB
#define PL_ALIVE			0xBC //version kontrolü
#define PL_UIINFO			0xBD
#define PL_PUS				0xBE
#define PL_CASHCHANGE		0xBF
//#define PL_KESN			0xAA			// oyunun kendisinde var.
//#define PL_DROP_LIST		0xAB		// PL_DROP_REQUEST ile aynı fonksiyon nerede kullanılıyor bilmiyorum
#define PL_ITEM_PROCESS		0xAC	// fonksiyon yok
#define PL_RESET			0xC0
#define PL_DROP_REQUEST		0xC1
#define PL_CR				0xC2
#define PL_CLANBANK			0xC3
#define PL_USERINFO			0xB1
#define PL_SLAVE_MERC		0xA9
#define PL_KCPAZAR			0xB2
#define PL_LOOT_SETTINS		0xC6
#define PL_CHAOTIC_EXCHANGE 0xC7
#define PL_MERCHANT			0xC9
#define PL_USERDATA			0xCA
#define PL_TEMPITEMS		0xCB
#define PL_GMTOOLS			0xF1
#define PL_AUTODROP			0xCD
#define PL_SUPPORT			0xCE	
#define PL_INFOMESSAGE		0xF7
#define PL_MERCHANTLIST		0xD6
#define PL_MESSAGE			0xD7
#define PL_MESSAGE2			0xC5
#define PL_LIFESKILL		0xD8
#define PL_PARTY_PROCESS	0xDD
#define PL_MONSTER_INFO		0xDA
#define PL_EVENT			0xDB
#define PL_VOICE			0xDC
#define PL_CHAOTIC_RESULT	0xC8
#define PL_MERC_WIEWER_INFO 0xA3
#define PL_ANVIL_PRE		0xA4	//ANVİL % ORANI
#define PL_DAILY			0xC4
#define PL_LOTTERY			0xD9
#define PL_2NDPASSWORD		0xE1
#define PL_RANK			    0xF3
#define PL_GENERALRANK		0xF4
#define PL_USER_TOOLS	    0xF5
#define PL_DEATH_NOTICE	    0xF6
#define PL_VS_EVENT		    0xF8
...
// ---------------------------------------------------------------------
// LOGIN Server Socket Connection Parameters
// ---------------------------------------------------------------------
const uint8 LOGIN_SERVER_CONNECT = 1;
const uint8 LOGIN_CONNECT_USER = 2;
const uint8 LOGIN_DISCONNECT_USER = 3;
const uint8 LOGIN_SERVER_TEST = 99;
...
enum CyberACSSystem
{
	WIZ_CYBERANTICHEAT_COM = 0xB7,
	WIZ_CYBERANTICHEAT_AUTHINFO = 0xB8,
	WIZ_CYBERANTICHEAT_PROCINFO = 0xB9,
	WIZ_CYBERANTICHEAT_OPEN = 0xBA,
	WIZ_CYBERANTICHEAT_LOG = 0xBB,
	WIZ_CYBERANTICHEAT_ALIVE = 0xBC,
	WIZ_CYBERANTICHEAT_UIINFO = 0xBD,
	WIZ_CYBERANTICHEAT_PUS = 0xBE,
	WIZ_CYBERANTICHEAT_CASHCHANGE = 0xBF,
	WIZ_CYBERANTICHEAT_RESET = 0xC0,
	WIZ_CYBERANTICHEAT_DROP_REQUEST = 0xC1,
	WIZ_CYBERANTICHEAT_CR = 0xC2,
	WIZ_CYBERANTICHEAT_CLANBANK = 0xC3,
	WIZ_CYBERANTICHEAT_USERINFO = 0xC4,
	WIZ_CYBERANTICHEAT_KCPAZAR = 0xC5,
	WIZ_CYBERANTICHEAT_LOOT_SETTINS = 0xC6,
	WIZ_CYBERANTICHEAT_CHAOTIC_EXCHANGE = 0xC7,
	WIZ_CYBERANTICHEAT_CHAOTIC_RESULT = 0xC8,
	WIZ_CYBERANTICHEAT_MERCHANT = 0xC9,
	WIZ_CYBERANTICHEAT_USERDATA = 0xCA,
	WIZ_CYBERANTICHEAT_TEMPITEMS = 0xCB,
	WIZ_CYBERANTICHEAT_GMTOOLS = 0xCC,
	WIZ_CYBERANTICHEAT_AUTODROP = 0xCD,
	WIZ_CYBERANTICHEAT_SUPPORT = 0xCE,
	WIZ_CYBERANTICHEAT_INFOMESSAGE = 0xCF,
	WIZ_CYBERANTICHEAT_MERCHANTLIST = 0xD6,
	WIZ_CYBERANTICHEAT_MESSAGE = 0xD7,
	WIZ_CYBERANTICHEAT_LIFESKILL = 0xD8,
	WIZ_CYBERANTICHEAT_HPINFO = 0xD9,
	WIZ_CYBERANTICHEAT_MONSTER_INFO = 0xDA,
	WIZ_CYBERANTICHEAT_EVENT = 0xDB,
	WIZ_CYBERANTICHEAT_VOICE = 0xDC,
	WIZ_CYBERANTICHEAT_PARTY_PROCESS = 0xDD,
};
